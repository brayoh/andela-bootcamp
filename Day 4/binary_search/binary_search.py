class BinarySearch(object):
    """ BinarySearch
        takes 2 parameters:
        length = length of list to generate
        step_diff = the step difference between consecutive numbers
    """
    ...
    # it's an iterator that generates values on the fly but doesn't keep them in memory
    # this will help improve the efficiency of our program given a bigger input
    ...
    # this method takes the number you want to find as a parameter
